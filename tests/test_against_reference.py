...
def _import_deepseek_kernel:
 ...
 return getattr(ds_kernel, "sparse_attn", None), getattr(
 ds_kernel, "hc_split_sinkhorn", None
 )
 except Exception:
 continue
 return None, None
...
def test_self_sparse_attn_handles_masked_indices:
 ...
 out_front_only = reference_sparse_attn(q, kv, attn_sink, topk_idxs_full[..., : K // 2].contiguous, D ** -0.5)
...
def test_self_csa_forward_shape_and_mask:
 ...
 q, kv, kv_compressed, indexer_scores, attn_sink, n_win, top_k,
