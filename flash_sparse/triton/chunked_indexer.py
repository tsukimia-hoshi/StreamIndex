 ...
 *,
 ...
 run_v = torch.full(
 (B, chunk_S, top_k), float("-inf"), dtype=torch.float32, device=q.device,
 )
 run_i = torch.full(
 (B, chunk_S, top_k), -1, dtype=torch.int64, device=q.device,
 )
