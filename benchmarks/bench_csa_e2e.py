...
def bench_csa_e2e(cfg: CsaConfig) -> dict:
 ...
 n_win=cfg.n_win, top_k=cfg.top_k, m=cfg.m, use_triton=True,
 )
 ref_fn = lambda: flash_csa_forward(
 q, kv, kv_compressed, q_idx, k_idx_compressed, weights, attn_sink,
 n_win=cfg.n_win, top_k=cfg.top_k, m=cfg.m, use_triton=False,
 )
...
def main:
 ...
 r = bench_csa_e2e(cfg)
 cfg_s = (
 f"S={cfg.S} n_h={cfg.n_h} d={cfg.d} n_I_h={cfg.n_I_h} c_I={cfg.c_I} "
 f"m={cfg.m} top_k={cfg.top_k}"
 )
 print(
